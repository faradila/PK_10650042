...
<script language="JavaScript" type="text/JavaScript">
		 ...
		 while ($data = mysql_fetch_array($hasil))
		 {
		   ...
		   $query2 = "SELECT DISTINCT kode_mapel FROM mengajar WHERE kode_kelas = '$kode_kelas'";
...
{		
		...
		echo "<font color='red'>*Maaf Anda Belum Memilih Option Yang tersedia</font><br>";
		}
		else{
		echo "<font face='arial'><b>Kelas &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp: $kelas<br>";
		echo "Kode Mapel &nbsp: $mapel</b></font><br><br>";
		...
		echo "<tr bgcolor='#DCDCDC'>
			...
			while($data=mysql_fetch_array($buka)){
					...
					echo "<td align='center'>$nama_mapel</td>";
					echo "<td align='center'>$kelas</td>";
					echo "<td align='center'><input type='text' name='nilai".$no."' value='$nilai' size=3></td>";
